...
class SearcherImpl implements Searcher {
    ...
    @Override
    public List<Match> getMatches(Integer s, int maxNumMatches) throws UnknownWordException {
        return getMatches(getVector(s), maxNumMatches);
    }

    @Override
    public double cosineDistance(Integer s1, Integer s2) throws UnknownWordException {
    ...
    @Override
    public ImmutableList<Double> getRawVector(Integer word) throws UnknownWordException {
    ...
    @Override
    public SemanticDifference similarity(Integer s1, Integer s2) throws UnknownWordException {
        ...
        return new SemanticDifference() {
            @Override
            public List<Match> getMatches(Integer word, int maxMatches) throws UnknownWordException {
